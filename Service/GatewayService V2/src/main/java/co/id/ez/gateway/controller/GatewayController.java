 ...
 */
package co.id.ez.gateway.controller;
...
public class GatewayController {
    ...
    public LinkedList<JSONObject> getTranmainData(String pTranmainTable, String pTranID, String pMitraID) {
        try {
        ...
        throw new ServiceException(RC.ERROR_INVALID_SWITCHING_REFNUM, "Transaction Not found with trxid [" + pTranID + "] mitra id ["+pMitraID+"]");
    }

    public void logMessage(String pComand, String pMsgId, String pCorrelationID, String pTrxID, RequestMapping reqMap, String pMessage, String pWid) {
        try {
            ...
            LogService.getInstance(this).db().log("[Success Execute logMessage]: {}", pMessage);
        } catch (Exception e) {
            LogService.getInstance(this).dbError().withCause(e).log("[Failed Execute logMessage]: " + pMessage, true);
        }
    }

    public void logDownMessage(String pComand, String pMsgId, String pCorrelationID, RequestMapping reqMap, JSONObject pMessage, String pWid) {
        try {
            ...
            DB.executeAsyncUpdate(CommonHanlder.dbName, builder);
            LogService.getInstance(this).db().log("[Success Execute logDownMessage]: {}", pMessage.toString());
        } catch (Exception e) {
            LogService.getInstance(this).error().withCause(e).log("[Failed Execute logDownMessage]: "+ pMessage.toString(), true);
        }
    }

    public void insertDeviceMitra(String comp_name, String os, String proc_rev, String proc_idnt, String device_id, String snkey, RequestMapping reqMap) {
        ...
        try {
            ...
            LogService.getInstance(this).db().log("[Success Execute ez_device_mitra]: {}", builder);
