...
public class MenuDeposit extends javax.swing.JPanel {
    ...
    private void init() {
        ...
        listMenu1.addItem(new Model_Menu(Icons.LARGE_DEPOSIT, "Saldo", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu(Icons.LARGE_LEDGER, "Mutasi", Model_Menu.MenuType.MENU));
    }
