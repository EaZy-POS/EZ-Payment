...
public class MenuProdukBiller extends javax.swing.JPanel {

    public MenuProdukBiller() {
        initComponents();
        setOpaque(false);
    ...
    private void init() {
        ...
        listMenu1.addItem(new Model_Menu(Icons.LARGE_SYNC, "Data Produk & Biller", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu(Icons.LARGE_ESTIMATE, "Margin Harga", Model_Menu.MenuType.MENU));
    }
