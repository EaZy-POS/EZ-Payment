...
import co.id.ez.ezpay.view.master.MasterUsersView;
 ...
 * @author RCS
 */
public class ViewUserManagement extends JPanel implements ListMenuConsumer{
    ...
    private void selectActivedMenu(int index){
        if (index != stage) {
            ...
            switch (index) {
                case 0:
                    loadModule(new MasterUsersView());
                    break;
                default:
                    loadModule(null);
                    break;
    ...
    private void initComponents() {
        ...
        menu = new co.id.ez.ezpay.view.menu.MenuUserManagement();
    ...
    private co.id.ez.ezpay.view.menu.MenuUserManagement menu;
