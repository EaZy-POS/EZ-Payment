 ...
 * @author RCS
 */
public class MitraAccess extends Mitra {
    ...
    public final void initForm() {
        ...
        Common.activateComponent(false, txt_userid, txt_password);
        resetForm();
    ...
    public void resetForm() {
        Common.clearText(txt_userid, txt_password);
        model = null;
        isShow = false;
    }
    ...
    private void showData(){
        if (this.model != null) {
            txt_userid.setText(isShow ? this.model.getUserIDValue() : getHiddenString(this.model.getUserIDValue()));
            txt_password.setText(isShow ? this.model.getUserPasswordValue(): getHiddenString(this.model.getUserPasswordValue()));
        }
    }
