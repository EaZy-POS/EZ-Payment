 ...
 * @author Lutfi
 */
public class DailyRecapPospaidModel implements DataTable{
    ...
    public DailyRecapPospaidModel(String number, String tanggal, String idtransaksi, String reffnum, String kasir, String subid, String name, String tarif, String bulan, String total) {
        this.number = number;
