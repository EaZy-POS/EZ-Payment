...
public class MenuUserManagement extends javax.swing.JPanel {
    ...
    private void init() {
        ...
        listMenu1.addItem(new Model_Menu(Icons.LARGE_USER_MANAGEMENT, "Pengguna", Model_Menu.MenuType.MENU));
    }
