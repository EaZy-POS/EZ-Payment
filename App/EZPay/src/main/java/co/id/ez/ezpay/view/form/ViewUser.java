...
import co.id.ez.ezpay.view.users.ProfileUserView;
 ...
 * @author RCS
 */
public class ViewUser extends JPanel implements ListMenuConsumer{
    ...
    private void selectActivedMenu(int index){
        if (index != stage) {
            ...
            switch (index) {
                case 0:
                    loadModule(new ProfileUserView(false));
                    break;
                default:
                    loadModule(null);
                    break;
    ...
    private void initComponents() {
        ...
        menu = new co.id.ez.ezpay.view.menu.MenuUser();
    ...
    private co.id.ez.ezpay.view.menu.MenuUser menu;
