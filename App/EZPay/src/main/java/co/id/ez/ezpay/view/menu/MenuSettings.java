...
public class MenuSettings extends javax.swing.JPanel {
    ...
    private void init() {
        ...
        listMenu1.addItem(new Model_Menu(Icons.LARGE_TOOLS, "Aplikasi", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu(Icons.LARGE_INTEGRATION, "Integrasi", Model_Menu.MenuType.MENU));
    }
