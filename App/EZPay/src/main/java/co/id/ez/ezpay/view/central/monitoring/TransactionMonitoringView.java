 ...
 */
package co.id.ez.ezpay.view.central.monitoring;
 ...
 * @author RCS
 */
public class TransactionMonitoringView extends CentralDataForm<CentralModuleModel> {
     ...
     */
    public TransactionMonitoringView() {
