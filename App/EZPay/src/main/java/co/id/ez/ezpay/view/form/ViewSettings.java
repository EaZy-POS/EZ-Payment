...
import co.id.ez.ezpay.view.settings.IntegrationConfigView;
import co.id.ez.ezpay.view.settings.IntegrationView;
import co.id.ez.ezpay.view.settings.ToolsView;
 ...
 * @author RCS
 */
public class ViewSettings extends JPanel implements ListMenuConsumer{
    ...
    private void selectActivedMenu(int index){
        if (index != stage) {
            ...
            switch (index) {
                case 0:
                    loadModule(new ToolsView());
                    break;
                case 1:
                    loadModule(new IntegrationConfigView());
                    break;
                default:
                    loadModule(null);
                    break;
    ...
    private void initComponents() {
        ...
        menu = new co.id.ez.ezpay.view.menu.MenuSettings();
    ...
    private co.id.ez.ezpay.view.menu.MenuSettings menu;
