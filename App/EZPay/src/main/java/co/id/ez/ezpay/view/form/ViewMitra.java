 ...
 * @author RCS
 */
public class ViewMitra extends JPanel implements ListMenuConsumer{
    ...
    private void selectActivedMenu(int index){
        if (index != stage) {
            ...
            switch (index) {
                case 0:
                    loadModule(new ProfileView(false));
                    break;
                default:
                    loadModule(null);
                    break;
    ...
    private void initComponents() {
        ...
        menu = new co.id.ez.ezpay.view.menu.MenuMitra();
    ...
    private co.id.ez.ezpay.view.menu.MenuMitra menu;
