...
import co.id.ez.ezpay.view.settings.SettingHargaJualView;
 ...
 * @author RCS
 */
public class ViewProdukBiller extends JPanel implements ListMenuConsumer{
    ...
    private void selectActivedMenu(int index){
        if (index != stage) {
            ...
            switch (index) {
                case 0:
                    loadModule(new SyncronizeView());
                    break;
                case 1:
                    loadModule(new SettingHargaJualView());
                    break;
                default:
                    loadModule(null);
                    break;
    ...
    private void initComponents() {
        ...
        menu = new co.id.ez.ezpay.view.menu.MenuProdukBiller();
    ...
    private co.id.ez.ezpay.view.menu.MenuProdukBiller menu;
