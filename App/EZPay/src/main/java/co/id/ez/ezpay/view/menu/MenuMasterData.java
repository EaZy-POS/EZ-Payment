...
public class MenuMasterData extends javax.swing.JPanel {
    ...
    private void init() {
        ...
        listMenu1.addItem(new Model_Menu(Icons.LARGE_MASTER_POSITION, "Master Jabatan", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu(Icons.LARGE_MASTER_EMPLOYES, "Master Karyawan", Model_Menu.MenuType.MENU));
